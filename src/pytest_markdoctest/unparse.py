# adopted from https://github.com/python/cpython/blob/3.7/Tools/parser/unparse.py
# LICENSE for this file: https://github.com/python/cpython/blob/3.7/LICENSE
...
class Unparser:
    ...
    def _Attribute(self, t):
        ...
        if (isinstance(t.value, ast.Num) and isinstance(t.value.n, int)) or (
            isinstance(t.value, ast.Constant) and isinstance(t.value.value, int)
        ):
            self.write(" ")
        self.write(".")
        self.write(t.attr)
